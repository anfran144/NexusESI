...
interface EventCalendarLeaderProps {
  eventId: number
}

export function EventCalendarLeader({ eventId }: EventCalendarLeaderProps) {
  ...
  // Filtros (solo para visualización, no incluye crear tareas)
  ...
  return (
    <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div id="filter-types" className="space-y-2" role="group" aria-label="Filtros por tipo de elemento">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="show-tasks" className="cursor-pointer">Mis Tareas</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="show-incidents"
      ...
      {/* Calendario - Configuración estándar de FullCalendar */}
      <Card>

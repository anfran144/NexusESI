...
export const Route = createFileRoute('/_authenticated/coordinator/eventos/$eventId/tasks/bank')({
    ...
    <PermissionGuard permission="events.tasks.manage">
      <DashboardLayout showFooter={true}>
        <DashboardContent
          ...
          description={`Asigna tareas sin comité a los comités del evento "${event.name}"`}
        >
          <div className="space-y-6">
            ...
            <TaskBankManager 
              ...
              onClearFilter={() => navigate({ to: `/coordinator/eventos/${eventId}/tasks/bank` })}
            />
          </div>
        </DashboardContent>
      </DashboardLayout>

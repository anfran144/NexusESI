...
<head>
    ...
    <title>Incidente Reportado - {{ $task->title }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="email-wrapper">
        <div class="container">
            <div class="header">
                ...
                <h1 class="header-title">Incidente Reportado</h1>
            ...
            <div class="content">
                ...
                <p class="message">
                    Se ha reportado un incidente en una tarea que requiere su atención.
                </p>
                ...
                <div class="incident-box">
                    ...
                    <p><strong>Fecha del Reporte:</strong> {{ $incident->created_at->format('d/m/Y H:i') }}</p>
                </div>

                <div class="details-box">
                    <h3>Tarea Afectada</h3>
                ...
                <div class="button-container">
                    ...
                    <a href="{{ config('app.frontend_url') }}/incidents" class="btn">
                        Ver Incidentes
                    </a>
                </div>

                <div class="warning-box">
                    <p><strong>Acción Requerida:</strong> Se ha reportado un incidente que requiere atención. 
                    Por favor, revise los detalles y tome las medidas necesarias para resolverlo.</p>
                </div>
            </div>

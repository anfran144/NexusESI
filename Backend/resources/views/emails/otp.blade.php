    ...
    <div class="email-wrapper">
        <div class="container">
            <div class="header">
                ...
                <h1 class="header-title">Restablecimiento de Contraseña</h1>
            ...
            <div class="content">
                ...
                <p class="message">
                    Ha solicitado restablecer su contraseña en NexusESI. Para continuar con el proceso, 
                ...
                <div class="security-notice">
                    <p><strong>Importante:</strong> Si no solicitó este cambio de contraseña, ignore este correo 
                    electrónico y asegúrese de que su cuenta esté segura. Nunca comparta este código con nadie.</p>
                </div>
                
                <p class="message">
                    Si tiene alguna pregunta o necesita ayuda, no dude en contactar con nuestro equipo de soporte.
                </p>
            </div>
